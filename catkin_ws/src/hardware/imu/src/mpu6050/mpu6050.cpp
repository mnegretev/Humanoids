...
IMU::IMUData<int16_t> MPU6050::getRawMotion6() {
  uint16_t buffer[7];
  IMU::IMUData<int16_t> raw_imu_data;
...
IMU::IMUData<float> MPU6050::getMotion6() {
  IMU::IMUData<float> imu_data;
  IMU::IMUData<int16_t> raw_data;
...
IMU::AccelData<int16_t> MPU6050::getRawAcceleration() {
  uint16_t buffer[3];
  IMU::AccelData<int16_t> raw_accel;
...
IMU::AccelData<float> MPU6050::getAcceleration() {
  IMU::AccelData<float> accel_data;
  IMU::AccelData<int16_t> raw_accel;
...
IMU::GyroData<int16_t> MPU6050::getRawRotation() {
  uint16_t buffer[3];
  IMU::GyroData<int16_t> raw_gyro_data;
...
IMU::GyroData<float> MPU6050::getRotation() {
  IMU::GyroData<float> gyro_data;
  IMU::GyroData<int16_t> raw_gyro_data;
...
IMU::IMUData<int16_t> MPU6050::getOffsets() {
  IMU::IMUData<int16_t> offsets;
