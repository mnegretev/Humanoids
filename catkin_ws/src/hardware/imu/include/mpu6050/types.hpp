#ifndef MPU6050_DRIVER_TYPES_HPP_
#define MPU6050_DRIVER_TYPES_HPP_
...
#define MPU6050_TC_OFFSET_BIT 1
...
#define MPU6050_DETECT_ACCEL_ON_DELAY_BIT 4
...
//Struct to hold Accelerometer values of the three axes.
template <typename T>
struct AccelData {
  T x;
  T y;
...
//Struct to hold Gyroscope values of the three axes.
template <typename T>
struct GyroData {
  T x;
  T y;
...
#endif  // MPU6050_DRIVER_TYPES_HPP_