...
class MPU6050 {
 public:
   ...
   */
  IMU::IMUData<int16_t> getRawMotion6();
   ...
   */
  IMU::AccelData<int16_t> getRawAcceleration();
   ...
   */
  IMU::AccelData<float> getAcceleration();
   ...
   * @see MPU6050_RA_GYRO_XOUT_H
   */
  IMU::GyroData<int16_t> getRawRotation();
   ...
   */
  IMU::GyroData<float> getRotation();
  ...
  IMU::IMUData<int16_t> getOffsets();
  void resetOffsets();
