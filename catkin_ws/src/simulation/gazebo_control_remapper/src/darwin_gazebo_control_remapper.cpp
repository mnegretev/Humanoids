...
{
    std::cout << "INITIALIZING DARWIN GAZEBO CONTROL MAPPER BY MARCOSOFT..." << std::endl;
    ros::init(argc, argv, "darwin_gazebo_control_remapper");
    ros::NodeHandle n;
    ros::Rate loop(30);
    ...
    pubLeftHipYaw         = n.advertise<std_msgs::Float64>("/darwin/left_hip_yaw_position_controller/command",1);
    pubLeftHipRoll        = n.advertise<std_msgs::Float64>("/darwin/left_hip_roll_position_controller/command",1);
    pubLeftHipPitch       = n.advertise<std_msgs::Float64>("/darwin/left_hip_pitch_position_controller/command",1);
    pubLeftKneePitch      = n.advertise<std_msgs::Float64>("/darwin/left_knee_pitch_position_controller/command",1);
    pubLeftAnklePitch     = n.advertise<std_msgs::Float64>("/darwin/left_ankle_pitch_position_controller/command",1);
    pubLeftAnkleRoll      = n.advertise<std_msgs::Float64>("/darwin/left_ankle_roll_position_controller/command",1); 
    pubRightHipYaw        = n.advertise<std_msgs::Float64>("/darwin/right_hip_yaw_position_controller/command",1);    
    pubRightHipRoll       = n.advertise<std_msgs::Float64>("/darwin/right_hip_roll_position_controller/command",1);   
    pubRightHipPitch      = n.advertise<std_msgs::Float64>("/darwin/right_hip_pitch_position_controller/command",1);  
    pubRightKneePitch     = n.advertise<std_msgs::Float64>("/darwin/right_knee_pitch_position_controller/command",1); 
    pubRightAnklePitch    = n.advertise<std_msgs::Float64>("/darwin/right_ankle_pitch_position_controller/command",1);
    pubRightAnkleRoll     = n.advertise<std_msgs::Float64>("/darwin/right_ankle_roll_position_controller/command",1);
    pubLeftShoulderPitch  = n.advertise<std_msgs::Float64>("/darwin/left_shoulder_pitch_position_controller/command", 1);
    pubLeftShoulderRoll   = n.advertise<std_msgs::Float64>("/darwin/left_shoulder_roll_position_controller/command",1);  
    pubLeftElbowPitch     = n.advertise<std_msgs::Float64>("/darwin/left_elbow_pitch_position_controller/command", 1); 
    pubRightShoulderPitch = n.advertise<std_msgs::Float64>("/darwin/right_shoulder_pitch_position_controller/command", 1);
    pubRightShoulderRoll  = n.advertise<std_msgs::Float64>("/darwin/right_shoulder_roll_position_controller/command", 1);
    pubRightElbowPitch    = n.advertise<std_msgs::Float64>("/darwin/right_elbow_pitch_position_controller/command", 1);
    pubNeckYaw            = n.advertise<std_msgs::Float64>("/darwin/neck_yaw_position_controller/command", 1);
    pubNeckPitch          = n.advertise<std_msgs::Float64>("/darwin/head_pitch_position_controller/command", 1);
