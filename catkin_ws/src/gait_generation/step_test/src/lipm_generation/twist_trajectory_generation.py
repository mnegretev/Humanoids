...
def get_twist_trajectory_left_first_step(p_start, duration, twist_angle, ik_client_left, ik_client_right):
    ...
    return left_q, right_q, r_leg_pose[-1], l_leg_pose[-1]
...
def main(args = None):
    ...
    left_q, right_q, last_p_com, _ = get_twist_trajectory_left_first_step(last_p_com, duration=2, twist_angle=math.pi/4, ik_client_left=left_leg_client, ik_client_right=right_leg_client)
