...
int main(int argc, char** argv)
{
    ...
    {
	leg_left_x     [i] = -0.01 * sin(4*M_PI*t) + left_start_x; //+ 0.004;
	leg_left_y     [i] = left_start_y;
	leg_left_z     [i] = 0.01 * fabs(sin(4*M_PI*t)) + left_start_z;
	leg_left_roll  [i] = 0;
	leg_left_pitch [i] = 0;
	leg_left_yaw   [i] = 0;
	...
	leg_left_pitch [i] = 0;
	leg_left_yaw   [i] = 0;
	leg_right_x    [i] = -0.01 * sin(4*M_PI*t) + right_start_x; //+ 0.004;
	leg_right_y    [i] = right_start_y;
	leg_right_z    [i] = 0.01 * fabs(sin(4*M_PI*t)) + right_start_z;
	leg_right_roll [i] = 0;
	leg_right_pitch[i] = 0;
	leg_right_yaw  [i] = 0;
	t += 1.0/30.0;
