...
{
    cout<<"Starting see_ball_node by Luis Näva..."<<endl;
    ros::init(argc, argv, "see_ball_node");
    ros::NodeHandle nh;
    ...
    ros::Publisher pub_angles = nh.advertise<std_msgs::Float32MultiArray>("/vision/ball_kinematics/vision_angles", 1000);
